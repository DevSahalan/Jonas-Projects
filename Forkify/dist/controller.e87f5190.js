...
var timeout = function timeout(seconds) {
  return new Promise(function (_, reject) {
    setTimeout(function () {
      reject(new Error("Request took too long! timeout after ".concat(seconds, " seconds")));
    }, seconds * 1000);
  });
};
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 8:
            _context.prev = 8;
            _context.t0 = _context["catch"](0);
            console.error("Error in model : ".concat(_context.t0));
...
var RecipeView = /*#__PURE__*/function () {
  ...
  _createClass(RecipeView, [{
    ...
    value: function render(data) {
      ...
      var markup = _classPrivateMethodGet(this, _generateMockup, _generateMockup2).call(this);
...
var _generateMockup2 = function _generateMockup2() {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 11:
            _context.prev = 11;
            _context.t0 = _context["catch"](0);
            console.error("Error from controller: ".concat(_context.t0));
...
var eveArr = ['hashchange', 'load'];
eveArr.forEach(function (eve) {
  return window.addEventListener(eve, showRecipe);
});
},{"./model.js":"src/js/model.js","./views/recipeView.js":"src/js/views/recipeView.js","core-js/stable":"node_modules/core-js/stable/index.js","regenerator-runtime/runtime":"node_modules/regenerator-runtime/runtime.js"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
